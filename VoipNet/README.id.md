...
| `VoipNet.Video` | Encode dan decode H.264, penangkapan kamera dan layar lewat codec bawaan platform (Media Foundation di Windows), pola uji untuk mesin tanpa keduanya, compositor grid/PiP, plus konversi BGRA/NV12. |
