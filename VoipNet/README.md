...
| `VoipNet.Video` | H.264 encoding and decoding, camera and screen capture through the platform's own codec (Media Foundation on Windows), a grid/PiP compositor, and BGRA/NV12 conversion. |
