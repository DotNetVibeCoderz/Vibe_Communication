...
| RTCP feedback negotiation (`a=rtcp-fb`: nack, nack pli, ccm fir) | ✅ | offered on video lines and echoed in answers (RFC 4585 4); without it a browser ignores the keyframe requests the conference needs to start a new viewer · negosiasi umpan balik RTCP di baris video |
